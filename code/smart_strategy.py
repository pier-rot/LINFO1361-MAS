...
class SmartStrategy(AntStrategy):
    ...
    def decide_action(self, perception: AntPerception) -> AntAction: 
        ...
        # Mémoire de la fourmi (initialisation)
        ...
        # Face à un mur ou un bord à l'action précédente et a déjà tourné à droite
        if mem["blocked"]:
        ...
        # --- Cherche de la nourriture --- #
            ...
            if should_deposit and perception.home_pheromone.get((0,0), 0) < 50 and mem["nSteps"] <= 500 and sum(x for x in perception.home_pheromone.values() if x > 1) < 7:
